...
var lazy_seq = (function (body) {
	return new crisp.types.List([]).cons(new crisp.types.List([]).cons(body).cons(new crisp.types.Vector([])).cons(new crisp.types.Symbol("fn"))).cons(new crisp.types.Symbol("crisp.types.LazySeq."));
});
lazy_seq.__metadata__ = {"macro":true};
exports.lazy_seq = lazy_seq;

var range = (function (x) {
	return new crisp.types.LazySeq((function () {
