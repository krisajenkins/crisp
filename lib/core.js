...
var crisp_do = (function () {
	...
	return crisp.types.cons(crisp.types.cons(new crisp.types.Symbol("fn"), crisp.types.cons(crisp.types.Vector.EMPTY, crisp.types.splice(body, crisp.types.List.EMPTY))), crisp.types.List.EMPTY);
});
crisp_do.__metadata__ = {"macro":true};
exports.crisp_do = crisp_do;

var defn = (function (name, args, body) {
	return crisp.types.cons(new crisp.types.Symbol("def"), crisp.types.cons(name, crisp.types.cons(crisp.types.cons(new crisp.types.Symbol("fn"), crisp.types.cons(args, crisp.types.cons(body, crisp.types.List.EMPTY))), crisp.types.List.EMPTY)));
});
...
var lazy_seq = (function (body) {
	return crisp.types.cons(new crisp.types.Symbol("LazySeq."), crisp.types.cons(crisp.types.cons(new crisp.types.Symbol("fn"), crisp.types.cons(crisp.types.Vector.EMPTY, crisp.types.cons(body, crisp.types.List.EMPTY))), crisp.types.List.EMPTY));
});
...
var crisp_let = (function (bindings) {
	...
	return (count(bindings) < 1) ? crisp.types.cons(crisp.types.cons(new crisp.types.Symbol("fn"), crisp.types.cons(crisp.types.Vector.EMPTY, crisp.types.splice(body, crisp.types.List.EMPTY))), crisp.types.List.EMPTY) : crisp.types.cons(crisp.types.cons(new crisp.types.Symbol("fn"), crisp.types.cons(crisp.types.cons(first(bindings), crisp.types.Vector.EMPTY), crisp.types.cons(crisp.types.cons(new crisp.types.Symbol("let"), crisp.types.cons(rest(rest(bindings)), crisp.types.splice(body, crisp.types.List.EMPTY))), crisp.types.List.EMPTY))), crisp.types.cons(second(bindings), crisp.types.List.EMPTY));
});
